...
class ZKAttendanceClient {
    ...
    isConnected(){
        return this.connectionType !== null && 
               ((this.connectionType === 'tcp' && this.jtcp.socket) || 
                (this.connectionType === 'udp' && this.judp.socket))
    }
    ...
    async setTime(date = new Date()){
        return await this.functionWrapper(
            ()=> this.jtcp.setTime(date),
            ()=> this.judp.setTime(date)
        )
    }
    ...
    async deleteUser(uid){
        return await this.functionWrapper(
            ()=> this.jtcp.deleteUser(uid),
            ()=> this.judp.deleteUser(uid)
        )
    }
...
module.exports = ZKAttendanceClient
